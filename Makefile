...
BUILD_DIR := build
LIB_SOURCES := src/field.cpp src/poly.cpp src/curve.cpp src/modpoly.cpp src/direct_modpoly.cpp src/prime_isogeny.cpp src/cm_surface.cpp src/trace.cpp src/atkin.cpp src/weber_table_trust.cpp \
