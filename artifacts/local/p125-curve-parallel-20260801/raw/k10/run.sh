...
vm_stat > /tmp/oneshotsea-k10-bench-20260801/vm-before-k10.txt
/usr/bin/time -p -o /tmp/oneshotsea-k10-bench-20260801/k10.time \
  ...
  --seed 202607300000 \
  --range-start 8 --range-end 18 --worker-id 0 --worker-count 1 \
  ...
  --checkpoint /tmp/oneshotsea-k10-bench-20260801/k10/checkpoint.json \
  --checkpoint-every 1 \
  --progress /tmp/oneshotsea-k10-bench-20260801/k10/progress.jsonl \
  --certificate-out /tmp/oneshotsea-k10-bench-20260801/k10/certificate.txt \
  --build-id bench:worktree-karatsuba+binary-sha256:01d9cabac89660094545c7cd42b83b1c6d06d74b5c979aec3d52ea14a01eee0e \
  --max-curves 10 \
  > /tmp/oneshotsea-k10-bench-20260801/k10.jsonl \
  2> /tmp/oneshotsea-k10-bench-20260801/k10.stderr
vm_stat > /tmp/oneshotsea-k10-bench-20260801/vm-after-k10.txt
