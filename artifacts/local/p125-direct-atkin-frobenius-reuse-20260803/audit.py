#!/usr/bin/env python3
"""Authenticate the p125 direct-Atkin Frobenius-reuse evidence."""
...
def main():
    ...
    equal(result["schema"],
          "oneshotsea.p125-direct-atkin-frobenius-reuse.v1",
          "result schema")
    ...
    equal(result["claims"], {
        "duplicate_frobenius_exponentiation_removed_per_atkin_level": True,
    ...
    print(json.dumps({
        "schema": "oneshotsea.p125-direct-atkin-frobenius-reuse-audit.v1",
        "ok": True,
