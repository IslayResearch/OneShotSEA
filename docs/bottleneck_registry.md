...
| Odd-degree norm eigenvalue sign | Exact norm recovery at `ell=3 mod 4` improved the targeted eigenvalue subtotal 1.52646x and total eigen recovery 1.25055x with every non-timing projection unchanged. Reverse-order p125 wall improved only 1.04907x, below the strict greater-than-1.05x gate, so the prototype remains rejected and outside production. |
