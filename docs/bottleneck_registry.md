...
|---|---|---|---|
| P0 | SEA cost per admitted curve | Threshold-32 exact Karatsuba, retained source state, exact-cost polynomial windows, polynomial-subring eigen powers, specialized three-square polynomial squaring, and in-place cross-term accumulation are committed in `43ca2d7`. The latter improved a bounded same-input p125 SEA wall by 1.07836x with all 42 projections unchanged. | Deploy the tested frozen build from frontier 247; measure its realized share in the new X1(27) production mix |
| P0 | Production certificate search | The durable frontier is 247. The final v1 attempt failed closed at 246 without advancing. The pushed `43ca2d7` frozen binary then reproduced the v2 prototype's canonical non-timing projection, reduced both complete sets to 2, soundly rejected all four orders, and advanced its isolated checkpoint to 247 complete. Its timing was contaminated and is release evidence only. | Launch sound-only X1(27) production at 247 with v2 fallback on and incomplete skip off |
